                    ...
                    <div class="panel-body">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a href="/channel/{{ $video->channel->slug }}"></a>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        @if ($video->commentsAllowed())
                            <video-comments user-id="{{ Auth::check() ? Auth::user()->id : '' }}" user-authenticated="{{ Auth::check() ? true : false }}" video-uid="{{ $video->uid }}"></video-comments>
                        @else
